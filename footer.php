<section class="ly_section hp_ptSm hp_pbMd" id="contact">
    <div class="ly_inner">
        <span class="el_section_ttl_sub">お問い合わせ</span>
        ...
        <div class="bl_section">
            ...
            <a href="https://www.instagram.com/mahouno.komeko_chiffoncake/" target="_blank" rel="noopener noreferrer"
                class="container hp_bgColor">
                <p>Instagramで問い合わせる</p>
            </a>
        </div>
    </div>
</section>
<footer class="ly_footer">
    <div class="ly_inner hp_flex hp_jcsb hp_pbMd">
        <div class="bl_footer_side">
            <div class="el_icon_wrapper hp_flex">
                <div class="el_icon">
                    <a href="https://www.instagram.com/mahouno.komeko_chiffoncake/" target="_blank"
        ...
        <div class="ly_footer_main hp_flex hp_jcsb">
            <ul class="bl_footer_nav">
                ...
                <li><a href="<?php echo esc_url(home_url('/'));?>/intro">INTRO</a></li>
                <ul>
            ...
            <ul class="bl_footer_nav">
                <li><a href="<?php bloginfo('url');?>/Cake">CAKE</a></li>
                <ul>
    ...
    <div class="ly_copyright">
        <div class="ly_inner hp_pt30 hp_pb30">
            <span>©2025 -SimpleYoga- All Rights Reserved.</span>
            <br>
